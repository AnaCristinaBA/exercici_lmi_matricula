...
<<<<<<< HEAD
=======
                     <xsl:value-of select='matricula/alumne/nom'></xsl:value-of>
...
<<<<<<< HEAD
=======
                    <xsl:value-of select='matricula/alumne/cognoms'></xsl:value-of>
>>>>>>> 24337f2 (Trabajo realizado)
                  </fo:block>
                </fo:table-cell>
              </fo:table-row>
...
<<<<<<< HEAD
=======
                      <xsl:value-of select='matricula/alumne/email'></xsl:value-of>
>>>>>>> 24337f2 (Trabajo realizado)
                    </fo:block>
                </fo:table-cell>
              </fo:table-row>
...
<<<<<<< HEAD
=======
                      <xsl:value-of select='matricula/alumne/adreca'></xsl:value-of>
>>>>>>> 24337f2 (Trabajo realizado)
                  </fo:block>
                </fo:table-cell>
              </fo:table-row>
...
<<<<<<< HEAD
=======
                      <xsl:value-of select='matricula/alumne/telefon'></xsl:value-of>
>>>>>>> 24337f2 (Trabajo realizado)
                  </fo:block>
                </fo:table-cell>
              </fo:table-row>
